...
#    Updated: 2018/11/12 15:07:55 by avogt            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_isprint.c ft_itoa.c ft_lstadd.c ft_lstdelone.c ft_lstdel.c ft_lstnew.c\
ft_lstmap.c ft_lstiter.c ft_memalloc.c ft_memccpy.c ft_memchr.c ft_memcmp.c\
...
ft_isprint.o ft_itoa.o ft_lstadd.o ft_lstdelone.o ft_lstdel.o ft_lstnew.o\
ft_lstmap.o ft_lstiter.o ft_memalloc.o ft_memccpy.o ft_memchr.o ft_memcmp.o\
ft_memcpy.o ft_memdel.o ft_memmove.o ft_memset.o ft_putnbr_fd.o ft_putchar.o\
ft_putendl.o ft_putendl_fd.o\
ft_putchar_fd.o ft_putstr.o ft_putstr_fd.o ft_putnbr.o ft_strcat.o ft_strncat.o\
ft_strlcat.o ft_strchr.o ft_strclr.o ft_strcmp.o ft_strcpy.o ft_strdel.o\
ft_strdup.o ft_strequ.o ft_strnequ.o ft_striter.o ft_striteri.o ft_strjoin.o\
ft_strlen.o ft_strmap.o ft_strmapi.o ft_strncmp.o ft_strncpy.o ft_strnew.o\
